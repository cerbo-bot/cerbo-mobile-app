          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Carousal Area
                model.selectedCategoryTab != "Recent"
                    ? Column(
                        children: [
                          Container(
                            ...
                            width: carousalWidth,
                            child: CerboCarousal(
                                newsList: (model.selectedCategoryTab
                                            .toLowerCase() ==
                                        "popular"
                                    ...
                                    : model.selectedCategoryTab.toLowerCase() ==
                                            "recent"
                                        ? model
                                            .categoriesCache?.recent?.carousel
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return CerboTabBarButton(
                                  ...
                                  name: (model.selectedCategoryTab
                                                  .toLowerCase() ==
                                              "popular"
                                          ? model.categoriesCache?.popular
                                              ?.regionalNews?.keys
                                              ?.toList()[index]
                    ...
                    : RecentView(
                        height: regionalNewsViewHeight + carousalHeight,
                        width: width,
                        model: model,
                      ),
              ],
